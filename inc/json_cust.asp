...
sqlstr = " select custid,custname  " & vbcrlf 
sqlstr = sqlstr & " from cust " & vbcrlf 
sqlstr = sqlstr & " where 1=1 " & vbcrlf 
if request("p")&"">"" then
sqlstr = sqlstr & " and (custid like '"&request("p")&"%' or custname like '%"&request("p")&"%') "
end if
...
if IsArray(lv1ARY) then
	for lv1=0 to ubound(lv1ARY,2)
		...
		jsa(Null)("custid") = trim(cstr(c1_id))
		jsa(Null)("custname") = trim(cstr(c1_name))
