...
Key_Word	= Request("Key_Word")                                                          
	...
	IF Key_Word = "" Then                                                        
		rs.Open	"Select * From D14T Where " & GNtmp & HNtmp & HBtmp & KINDtmp &        " ID <> 0 Order By ID", conn, 3                                                          
	Else                                                      
		Etmp = " ( EW Like '%" & Key_Word & "%' OR EH Like '%" & Key_Word & "%' OR EO Like '%" & Key_Word & "%' ) AND "                                                      
		rs.Open	"Select * From D14T Where " & GNtmp & HNtmp & HBtmp & KINDtmp & Etmp & " ID <> 0 Order By ID", conn, 3                         
	End IF                                                          
	...
	For p = 1 to rs.PageCount                                                          
		PageLink = PageLink & "<a href='Discuss14TR.asp?Page=" & p & "&GN=" & GN & "&HN=" & HN & "&HB=" & HB & "&KIND=" & KIND & "&Key_Word=" & Key_Word & " '>[" & p & "]</a>"                                                          
	Next                                         
	                                             
	If Page > 1 Then                                                                                                                     
		BackPage = "<a href='Discuss14TR.asp?Page=" & Page-1 & "&GN=" & GN & "&HN=" & HN & "&HB=" & HB & "&KIND=" & KIND & "&Key_Word=" & Key_Word & " '>[上一頁]</a> "                                                                                                       
	Else                                                                                                       
		BackPage = ""                                                                                                       
	End If                                                                                                              
	                                
	If Page - rs.PageCount < 0 Then                                                                                                                     
		NextPage = "<a href='Discuss14TR.asp?Page=" & Page+1 & "&GN=" & GN & "&HN=" & HN & "&HB=" & HB & "&KIND=" & KIND & "&Key_Word=" & Key_Word & " '>[下一頁]</a> "                                                                                                       
	Else                                                                                                       
		NextPage = ""                                                                                                       
	End If                                                      
%>                                                      
