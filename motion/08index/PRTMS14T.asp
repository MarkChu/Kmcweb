...
rsGN.Open  "Select Distinct GN From D14T Order By GN Desc", conn, 3
	While Not rsGN.EOF
		GN = rsGN("GN")
...
rsHN.Open  "Select Distinct HN From D14T Order By HN Asc", conn, 3
	While Not rsHN.EOF
		HN = rsHN("HN")
...
rsHB.Open  "Select Distinct HB From D14T Order By HB Asc", conn, 3
	While Not rsHB.EOF
		HB2 = rsHB("HB")
		IF HB2 = "1" Then     
			HB = "定期會"     
...
rsKIND.Open  "Select Distinct KIND From D14T Order By KIND Asc", conn, 3
...
%>
                              ...
                              <form action="Discuss14TR.asp" method="POST">     
                                <div align="center">      
                                  <p>&nbsp;</p>     
                                  <table border="1" cellpadding="2" cellspacing="1" bordercolor="#CCCC99" width="95%" align="center">     
                                    <tr align="center">      
                                      <td colspan="2" height="25" bgcolor="#999966">      
                                        <div align="left">
                                          <p align="center"><font color="#FFFFFF" size="3">基　隆　市　議　會　　　</font><font color="#FFFFFF" size="3">第　十　四　屆<br>
