...
rsGN.Open  "Select Distinct GN From D15 Order By GN Desc", conn, 3
	While Not rsGN.EOF
		GN = rsGN("GN")
...
rsHN.Open  "Select Distinct HN From D15 Order By HN Asc", conn, 3
	While Not rsHN.EOF
		HN = rsHN("HN")
...
rsHB.Open  "Select Distinct HB From D15 Order By HB Asc", conn, 3
	While Not rsHB.EOF
		HB2 = rsHB("HB")
		IF HB2 = "1" Then     
			HB = "定期會"     
...
rsKIND.Open  "Select Distinct KIND From D15 Order By KIND Asc", conn, 3
            ...
            <table width="95%" border="0" cellspacing="0" cellpadding="4" align="center">
              <tr> 
                <td valign="top" align="center"> 
                  <blockquote>
                    <div align="left">[<a href="default.asp">議事檢索</a>] / 第十五屆議決案 </div>          
                  </blockquote>     
                        ...
                        <table border="0" cellpadding="2" cellspacing="2" width="100%">     
                          <tr>      
                            <td valign="top" background="../img/flower-1.jpg" msnavigation>      
                              <form action="Search_15.asp" method="POST">     
                                <div align="center">      
                                  <p>&nbsp;</p>     
                                  <table border="1" cellpadding="2" cellspacing="1" bordercolor="#CCCC99" width="95%" align="center">     
                                    <tr align="center">      
                                      <td colspan="2" height="25" bgcolor="#999966">      
                                        <div align="left">
                                          <p align="center"><font color="#FFFFFF" size="3">基　隆　市　議　會　第　十　五　屆<br>
