...
conn.Open "driver={Microsoft Access Driver (*.mdb)};dbq=" & DBPath                                                          
	...
	IF Key_Word = "" Then                                                        
		rs.Open	"Select * From D15T Where " & GNtmp & HNtmp & HBtmp & KINDtmp &        " ID <> 0 Order By ID", conn, 3                                                          
	Else                                                      
		Etmp = " ( EW Like '%" & Key_Word & "%' OR EH Like '%" & Key_Word & "%' OR EO Like '%" & Key_Word & "%' ) AND "                                                      
		rs.Open	"Select * From D15T Where " & GNtmp & HNtmp & HBtmp & KINDtmp & Etmp & " ID <> 0 Order By ID", conn, 3                         
	End IF                                                          
	...
	For p = 1 to rs.PageCount                                                          
		PageLink = PageLink & "<a href='search_15T.asp?Page=" & p & "&GN=" & GN & "&HN=" & HN & "&HB=" & HB & "&KIND=" & KIND & "&Key_Word=" & Key_Word & " '>[" & p & "]</a>"                                                          
	Next                                         
	                                             
	If Page > 1 Then                                                                                                                     
		BackPage = "<a href='search_15T.asp?Page=" & Page-1 & "&GN=" & GN & "&HN=" & HN & "&HB=" & HB & "&KIND=" & KIND & "&Key_Word=" & Key_Word & " '>[上一頁]</a> "                                                                                                       
	Else                                                                                                       
		BackPage = ""                                                                                                       
	End If                                                                                                              
	                                
	If Page - rs.PageCount < 0 Then                                                                                                                     
		NextPage = "<a href='search_15T.asp?Page=" & Page+1 & "&GN=" & GN & "&HN=" & HN & "&HB=" & HB & "&KIND=" & KIND & "&Key_Word=" & Key_Word & " '>[下一頁]</a> "                                                                                                       
	Else                                                                                                       
		NextPage = ""                                                                                                       
	End If                                                      
                          ...
                          <tr>                                                         
                            <td  colspan="2">                                                         
                              <table cellpadding="1" cellspacing="1" border="0" width="100%">                                                        
                                ...
                                <tr bgcolor="#F2F1FC">                                                         
                                  <td width="15%" align="right"><font size="2">議　　決：</font></td>                                                                        
                                  <td width="87%"><font size="2">                                                        
                                    <% = EHrs %>                                                       
                                    </font></td>                                                       
                                </tr>                                                       
